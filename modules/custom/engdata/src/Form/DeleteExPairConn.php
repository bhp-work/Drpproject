...
/**
 * Class DeleteExPairConn.
 *
 * @package Drupal\engdata\Form
 */
class DeleteExPairConn extends ConfirmFormBase {
  ...
  public function getCancelUrl() {
    return new Url('engdata.exchangepairs');
}
public function getDescription() {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
   ...
   $query = \Drupal::database();
    //echo $this->id; die;
    // $query->delete('xb_exchcurrencies')
    //     //->fields($field)
   ...
   // $form_state->setRedirect('/list/masterexchange');
    $form_state->setRedirect('engdata.exchangepairs');
  }
