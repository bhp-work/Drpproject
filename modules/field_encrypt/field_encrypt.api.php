 ...
 * "🔒" by default, to indicate there is data for the field, but it's stored
 * encrypted. For some field types this value would not be accepted, so this
 * hook makes it possible to store an alternative value for specific field
 * types.
 *
 * @param mixed &$unencrypted_storage_value
 ...
 *
 * @see \Drupal\field_encrypt\ProcessEntities::ENCRYPTED_VALUE
 */
function hook_field_encrypt_unencrypted_storage_value_alter(&$unencrypted_storage_value, array $context) {
